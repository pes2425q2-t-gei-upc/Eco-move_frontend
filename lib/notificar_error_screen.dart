...
class _NotificarErrorScreenState extends State<NotificarErrorScreen> {
  ...
  Future<void> fetchTiposError() async {
    final url = Uri.parse('http://127.0.0.1:8000/api_punts_carrega/tipos_error_estacion/');
    try {
  ...
  final url = Uri.parse(
    'http://127.0.0.1:8000/api_punts_carrega/estacions/${widget.idStation}/reportar_error/',
  );
